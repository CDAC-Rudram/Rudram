  ...
  return (
    <div className="educational-corner">
      ...
      <section>
        ...
        <p>Answers to common questions and myths about blood donation.</p>
      </section>
      ...
      <section>
        ...
        <p>How to find a donation center and get support.</p>
      </section>
    </div>
  );
};
