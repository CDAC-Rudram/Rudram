      ...
      <div>
        ...
        <div className="card">
            ...
            <div className="card-content">
                <h3>Blood Donor</h3>
                <p>Donors are backbone.Once they donate blood they will get access to Coupons.</p>
        ...
        <div className="card">
            ...
            <div className="card-content">
                <h3>Blood Bank</h3>
                <p>Blood Bank gets more Blood Donors and also Live Donors in case of Emergency.</p>
                <a href="#" className="btn">Read More</a>
            </div>
        </div>
        <div className="card">
