...
import BloodDonationLogin from './images/BloodDonationLogin.jpg';
        ...
        <div>
            ...
            <div className="login-container">
                ...
                <div className="login-content">
                    <img src={BloodDonationLogin} alt="Blood Donation Login" className="login-image" />
                    {!otpSent ? (
                        <div className="login-form">
                            ...
                            <div className="login-buttons">
                                <button className="creset-button" onClick={handleReset}>Reset</button>
                                <button className="csubmit-button" onClick={handleSubmit}>Submit</button>
                            </div>
                        </div>
                    ) : (
                        <OtpForm 
