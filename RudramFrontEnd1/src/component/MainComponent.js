...
const MainComponent = () => {
  ...
  return (
    <section className="home-section">
      ...
      <p><h4>The importance of regular blood donations cannot be overstated. Blood donations are a critical component of healthcare, saving countless lives each year.</h4></p>
