        ...
        <div>
            ...
            <div className="login-container">
                ...
                <div className="login-content">
                    <img src={DonorLogin} alt="Donor Login" className="login-image" />
                    {!otpSent ? (
                        <div className="login-form">
                            ...
                            <div className="login-buttons">
                                <button className="dreset-button" onClick={handleReset}>Reset</button>
                                <button className="dsubmit-button" onClick={handleSubmit}>Submit</button>
                            </div>
                        </div>
                    ) : (
                        <OtpForm 
