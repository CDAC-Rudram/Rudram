...
import './Hospital.css'; // Create a separate CSS file if needed
import HospitalLogin from './images/HospitalLogin.jpg'; // Add a hospital-specific image if desired
    ...
    return (
        <div>
            ...
            <div className="login-container">
                <div className="login-header">Hospital Login</div>
                <div className="login-content">
                    <img src={HospitalLogin} alt="Hospital Login" className="login-image" />
                    {!otpSent ? (
                        <div className="login-form">
                            ...
                            <div className="login-buttons">
                                <button className="hreset-button" onClick={handleReset}>Reset</button>
                                <button className="hsubmit-button" onClick={handleSubmit}>Submit</button>
                            </div>
                        </div>
                    ) : (
                        <OtpForm 
