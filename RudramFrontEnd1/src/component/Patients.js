        ...
        <div>
            ...
            <div className="login-container">
                ...
                <div className="login-content">
                    <img src={PatientLogin} alt="Patient Login" className="login-image" />
                    {!otpSent ? (
                        <div className="login-form">
                            ...
                            <div className="login-buttons">
                                <button className="preset-button" onClick={handleReset}>Reset</button>
                                <button className="psubmit-button" onClick={handleSubmit}>Submit</button>
                            </div>
                        </div>
                    ) : (
                        <OtpForm 
